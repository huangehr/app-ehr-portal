        ...
        <div class="index-left-scroll c-hidden bgc-fff"  >
            ...
            <div  class="sidebar-menu plr30 c-f14 c-hidden" ms-controller="apps" >
                <ul class="pb50" id="app-main" ms-each-el="apps">
                    <li>
                        <a href="#" nav="home" name="个人主页" data-src="/doctor/home" class="curr"><img src="${staticRoot}/images/app_1.png" class="img-gray" /><input ms-duplex="el.name" /> <s class="c-arrow c-arrow-r"><s></s></s></a>
                    </li>
