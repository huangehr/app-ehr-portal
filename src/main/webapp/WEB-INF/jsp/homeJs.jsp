...
//                        loading.DOM.close.hide();
                ...
                warndialog:function (msg) {
                    $.ligerDialog.open({
                        type: 'info',
                        content: '<div class="dialog-judge"><div class="warnning-icon"></div><div style="color:#323232;font-size: 0.1rem;">'+msg+'</div></div>',
                     });
                }
            };
            Home.init();
