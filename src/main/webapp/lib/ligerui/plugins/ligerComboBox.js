...
(function ($)
{
    ...
    $.ligerui.controls.ComboBox.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function ()
        {
            ...
            // [代码片段002][修正当this.element为Input时is(":hidden")判断可能出现错误导致下拉框下多显示了一个输入框的问题][yezehua]
            //if ($(this.element).is(":hidden"))
            // [代码片段002][修正当this.element为Input时is(":hidden")判断可能出现错误导致下拉框下多显示了一个输入框的问题][yezehua] 结束
            ...
            //外层
            // TODO [代码片段006][增加‘j-text-wrapper’类用于表单验证失败时样式控制][yezeh]
            // g.wrapper = g.inputText.wrap('<div class="l-text l-text-combobox"></div>').parent();
            g.wrapper = g.inputText.wrap('<div class="l-text l-text-combobox j-text-wrapper"></div>').parent();
            // TODO [代码片段006][增加‘j-text-wrapper’类用于表单验证失败时样式控制][yezeh] 结束
            ...
            //滚动条样式的样式更改
            $(".l-box-select-inner").mCustomScrollbar({theme: "3d"});
            ...
            }).click(function ()
            {
                ...
                // TODO [代码片段003][点击下拉按钮后获取焦点以便进行表单验证][yezehua]
                g.inputText.focus();
                // TODO [代码片段003][点击下拉按钮后获取焦点以便进行表单验证][yezehua]
            });
        ...
        clear: function ()
        {
            ...
            this.trigger('clear');
            // TODO [代码片段004][清空内容后获取焦点以便进行表单验证][yezehua]
        ...
        // TODO [代码片段001][增加选择项方法][yezehua]
        selectItemByIndex: function (index) {
            if(index===undefined) return;
            this.selectValue($('tr',this.selectBox).eq(index).attr('value'));
        },
        // TODO [代码片段001][增加选择项方法][yezehua] 结束
                ...
                success: function (result)
{
        ...
        _addClickEven: function ()
        {
            ...
            $(".l-table-nocheckbox td", g.selectBox).click(function ()
            {
                ...
                // TODO [代码片段005][选择后失去焦点以便进行表单重新验证][yezehua]
                g.inputText.blur();
                // TODO [代码片段005][选择后失去焦点以便进行表单验证][yezehua] 结束
            });
        },
