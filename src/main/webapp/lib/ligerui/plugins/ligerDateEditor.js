...
(function ($)
{
    ...
    $.ligerui.controls.DateEditor.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function ()
        {
            ...
            // TODO [代码片段004][增加‘j-text-wrapper’类用于表单验证失败时样式控制][yezeh]
        ...
        showDate: function ()
        {
            ...
            this.onTextChange();
            // TODO [代码片段003][选择后获取焦点以便进行表单验证][yezehua]
            this.inputText.focus();
            // TODO [代码片段003][选择后获取焦点以便进行表单验证][yezehua] 结束
        },
        ...
        clear: function ()
        {
            this.set('value', '');
            this.usedDate = null;
            // TODO [代码片段002][清除内容后获取焦点以便进行表单验证][yezehua]
            this.inputText.focus();
            // TODO [代码片段002][清除内容后获取焦点以便进行表单验证][yezehua] 结束
        },
        //取消选择 
        ...
        _setHeight: function (value)
        {
            ...
            if (value > 4)
            {
                ...
                // TODO [代码片段001][修复文本框高度超出其外层容器后不见边框问题][yezehua]
                //g.inputText.css({ height: value});
                g.inputText.css({ height: value -2 });
                // TODO [代码片段001][修复文本框高度超出其外层容器后不见边框问题][yezehua] 结束
